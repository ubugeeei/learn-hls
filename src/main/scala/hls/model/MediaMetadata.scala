 ...
 *
 * Client attributes beginning with `X-` are retained verbatim. SCTE-35 values are represented as
 * hexadecimal strings because interpreting splice commands belongs to the SCTE-35 domain, not the
 * playlist grammar.
